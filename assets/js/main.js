...
let postArray = document.querySelector('.post-area-list');
let post_data = "";


facebookPost.reverse().map((items) => {
    post_data += `
    <div class="user-post">
    <div class="user-post-header">
      <div class="post-info">
        <img src="${items.post_author.photo}" alt="" />
        <div class="user-details">
          <a class="author" href="#">${items.post_author.name}</a>
          <span
            >${items.post_ago}
            <svg
              fill="currentColor"
    ...
    <div class="post-comments">
      <div class="comments-header">
        <div class="reaction">
          ...
          <a href="#">${items.post_like} others</a>
        </div>
        <div class="counts">
          <a href="#">${items.post_comment} Comments</a>
        </div>
      </div>
...
postArray.innerHTML = post_data;

$('.post-menu button.heide-show').click(function(){
    $('.post-dropdown-menu').slideToggle(500)
});